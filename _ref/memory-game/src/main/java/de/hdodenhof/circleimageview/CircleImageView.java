    ...
    private void setup() {
        if (!this.mReady) {
            ...
            if (!this.mBorderOverlay && this.mBorderWidth > 0) {
                this.mDrawableRect.inset(((float) this.mBorderWidth) - DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, ((float) this.mBorderWidth) - DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
            }
