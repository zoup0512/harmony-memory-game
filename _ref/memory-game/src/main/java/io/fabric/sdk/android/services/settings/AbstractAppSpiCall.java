    ...
    private HttpRequest applyMultipartDataTo(HttpRequest request, AppRequestData requestData) {
        ...
        if (requestData.icon != null) {
            ...
            try {
                ...
                request.part(APP_ICON_HASH_PARAM, requestData.icon.hash).part(APP_ICON_DATA_PARAM, ICON_FILE_NAME, "application/octet-stream", inputStream).part(APP_ICON_WIDTH_PARAM, Integer.valueOf(requestData.icon.width)).part(APP_ICON_HEIGHT_PARAM, Integer.valueOf(requestData.icon.height));
