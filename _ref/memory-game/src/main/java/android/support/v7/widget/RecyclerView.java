...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    public static abstract class ViewHolder {
        ...
        public final void setIsRecyclable(boolean recyclable) {
            ...
            if (this.mIsRecyclableCount < 0) {
                this.mIsRecyclableCount = 0;
                Log.e(BranchEvent.VIEW, "isRecyclable decremented below 0: unmatched pair of setIsRecyable() calls for " + this);
    ...
    private String getFullClassName(Context context, String className) {
        ...
        return !className.contains(FileUtils.HIDDEN_PREFIX) ? RecyclerView.class.getPackage().getName() + '.' + className : className;
    }
