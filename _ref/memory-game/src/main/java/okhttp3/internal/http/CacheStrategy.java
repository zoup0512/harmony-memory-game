...
public final class CacheStrategy {
    ...
    public static class Factory {
        ...
        private CacheStrategy getCandidate() {
            ...
            if (responseCaching.noCache() || ageMillis + minFreshMillis >= freshMillis + maxStaleMillis) {
                ...
                if (this.etag != null) {
                    ...
                    conditionalRequestBuilder.header(com.amazonaws.services.s3.Headers.GET_OBJECT_IF_MODIFIED_SINCE, this.lastModifiedString);
                } else if (this.servedDate != null) {
                    conditionalRequestBuilder.header(com.amazonaws.services.s3.Headers.GET_OBJECT_IF_MODIFIED_SINCE, this.servedDateString);
                }
        ...
        private static boolean hasConditions(Request request) {
            return (request.header(com.amazonaws.services.s3.Headers.GET_OBJECT_IF_MODIFIED_SINCE) == null && request.header("If-None-Match") == null) ? false : true;
        }
    }
