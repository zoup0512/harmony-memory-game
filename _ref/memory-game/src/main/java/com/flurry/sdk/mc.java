...
public final class mc {
    ...
    public static String a(String str) {
        ...
        String toLowerCase = scheme.toLowerCase(Locale.getDefault());
    ...
    public static boolean f(String str) {
        ...
        Uri parse = Uri.parse(str);
        if (parse.getHost() == null || !parse.getHost().equals("play.google.com") || parse.getScheme() == null || !parse.getScheme().startsWith(Constants.HTTP)) {
            return false;
        }
        return true;
    }
    ...
    public static boolean h(String str) {
        ...
        if (i.getScheme() == null || Constants.HTTP.equalsIgnoreCase(i.getScheme()) || Constants.HTTPS.equalsIgnoreCase(i.getScheme())) {
            return true;
        }
        return false;
    }
