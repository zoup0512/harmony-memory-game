...
public class FirebaseMessaging {
    ...
    private static final Pattern baO = Pattern.compile("[a-zA-Z0-9-_.~%]{1,900}");
    private static FirebaseMessaging baP;
    private PendingIntent baQ;
    ...
    public static synchronized FirebaseMessaging getInstance() {
        ...
        synchronized (FirebaseMessaging.class) {
            if (baP == null) {
                baP = new FirebaseMessaging(FirebaseInstanceId.getInstance());
            }
            firebaseMessaging = baP;
        }
    ...
    private synchronized void zzk(Context context, Intent intent) {
        if (this.baQ == null) {
            ...
            this.baQ = PendingIntent.getBroadcast(context, 0, intent2, 0);
        }
        intent.putExtra(SettingsJsonConstants.APP_KEY, this.baQ);
    }
    ...
    public void send(RemoteMessage remoteMessage) {
        ...
        String zzdi = zzf.zzdi(applicationContext);
        if (zzdi == null) {
    ...
    public void subscribeToTopic(String str) {
        ...
        if (substring == null || !baO.matcher(substring).matches()) {
        ...
        instance.zzsv(valueOf3.length() != 0 ? valueOf2.concat(valueOf3) : new String(valueOf2));
    }
