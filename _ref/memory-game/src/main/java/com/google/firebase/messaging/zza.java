...
class zza {
    ...
    static synchronized zza zzer(Context context) {
        ...
        synchronized (zza.class) {
            ...
            com_google_firebase_messaging_zza = baM;
        }
    ...
    private String zzg(Bundle bundle, String str) {
        ...
        if (identifier == 0) {
            ...
            valueOf2 = String.valueOf(zzjz(valueOf2.length() != 0 ? valueOf.concat(valueOf2) : new String(valueOf)));
    ...
    private Uri zzkb(String str) {
        ...
        if (Branch.REFERRAL_BUCKET_DEFAULT.equals(str) || this.mContext.getResources().getIdentifier(str, "raw", this.mContext.getPackageName()) == 0) {
