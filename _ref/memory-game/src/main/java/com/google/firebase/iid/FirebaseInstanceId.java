...
public class FirebaseInstanceId {
    ...
    private FirebaseInstanceId(FirebaseApp firebaseApp, zzd com_google_firebase_iid_zzd) {
        ...
        this.bav = com_google_firebase_iid_zzd;
        if (this.baw == null) {
    ...
    public static synchronized FirebaseInstanceId getInstance(@NonNull FirebaseApp firebaseApp) {
        ...
        synchronized (FirebaseInstanceId.class) {
            ...
            if (firebaseInstanceId == null) {
                ...
                aap.put(firebaseApp.getOptions().getApplicationId(), firebaseInstanceId);
            }
        }
    ...
    static void zza(Context context, zzg com_google_firebase_iid_zzg) {
        com_google_firebase_iid_zzg.zzbmd();
    ...
    String zzcws() {
        ...
        gcmSenderId = this.bau.getOptions().getApplicationId();
    ...
    String zzcwu() throws IOException {
    ...
    void zzsw(String str) throws IOException {
        if (getToken() == null) {
        ...
        zzd com_google_firebase_iid_zzd = this.bav;
        valueOf = getToken();
    ...
    void zzsx(String str) throws IOException {
        if (getToken() == null) {
            throw new IOException("token not available");
        }
        Bundle bundle = new Bundle();
