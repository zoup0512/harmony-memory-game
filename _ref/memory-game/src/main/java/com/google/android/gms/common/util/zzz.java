...
public class zzz {
    private static final Method Bm = zzawc();
    private static final Method Bn = zzawd();
    private static final Method Bo = zzawe();
    private static final Method Bp = zzawf();
    private static final Method Bq = zzawg();
