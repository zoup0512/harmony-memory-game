...
public interface zzt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzt {
        ...
        private static class zza implements zzt {
            ...
            public IBinder zza(zzd com_google_android_gms_dynamic_zzd, String str, zzgj com_google_android_gms_internal_zzgj, int i) throws RemoteException {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    IBinder zza = zza(com.google.android.gms.dynamic.zzd.zza.zzfc(parcel.readStrongBinder()), parcel.readString(), com.google.android.gms.internal.zzgj.zza.zzaj(parcel.readStrongBinder()), parcel.readInt());
    ...
    IBinder zza(zzd com_google_android_gms_dynamic_zzd, String str, zzgj com_google_android_gms_internal_zzgj, int i) throws RemoteException;
}
