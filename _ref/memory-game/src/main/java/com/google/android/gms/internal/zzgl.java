...
public interface zzgl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzgl {

        private static class zza implements zzgl {
            ...
            public void zza(zzgm com_google_android_gms_internal_zzgm) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.mediation.client.IMediationAdapterListener");
                    obtain.writeStrongBinder(com_google_android_gms_internal_zzgm != null ? com_google_android_gms_internal_zzgm.asBinder() : null);
        ...
        public static zzgl zzal(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.mediation.client.IMediationAdapterListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzgl)) ? new zza(iBinder) : (zzgl) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 7:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.mediation.client.IMediationAdapterListener");
                    zza(com.google.android.gms.internal.zzgm.zza.zzam(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 8:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.mediation.client.IMediationAdapterListener");
    ...
    void zza(zzgm com_google_android_gms_internal_zzgm) throws RemoteException;
}
