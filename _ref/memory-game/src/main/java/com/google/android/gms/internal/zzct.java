...
public class zzct {
    ...
    static void zza(int i, long j, String str, int i2, PriorityQueue<zza> priorityQueue) {
        zza com_google_android_gms_internal_zzct_zza = new zza(j, str, i2);
        if ((priorityQueue.size() != i || (((zza) priorityQueue.peek()).zzatj <= com_google_android_gms_internal_zzct_zza.zzatj && ((zza) priorityQueue.peek()).value <= com_google_android_gms_internal_zzct_zza.value)) && !priorityQueue.contains(com_google_android_gms_internal_zzct_zza)) {
            priorityQueue.add(com_google_android_gms_internal_zzct_zza);
    ...
    public static void zza(String[] strArr, int i, int i2, PriorityQueue<zza> priorityQueue) {
        ...
        while (i4 < (strArr.length - i2) + 1) {
            long zza2 = zza(zzcr.zzac(strArr[i4 - 1]), zzcr.zzac(strArr[(i4 + i2) - 1]), zzb, zza, 16785407);
