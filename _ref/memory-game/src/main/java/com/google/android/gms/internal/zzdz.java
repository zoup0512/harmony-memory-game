...
public interface zzdz extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzdz {
        ...
        private static class zza implements zzdz {
            ...
            public String zzat(String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.formats.client.INativeCustomTemplateAd");
            ...
            public zzdr zzau(String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.formats.client.INativeCustomTemplateAd");
    ...
    String zzat(String str) throws RemoteException;

    zzdr zzau(String str) throws RemoteException;
}
