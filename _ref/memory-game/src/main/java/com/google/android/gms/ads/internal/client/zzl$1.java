...
class zzl$1 extends zzl$zza<zzu> {
    ...
    zzl$1(zzl com_google_android_gms_ads_internal_client_zzl, Context context, AdSizeParcel adSizeParcel, String str, zzgj com_google_android_gms_internal_zzgj) {
    ...
    public zzu zza(zzx com_google_android_gms_ads_internal_client_zzx) throws RemoteException {
        return com_google_android_gms_ads_internal_client_zzx.createBannerAdManager(zze.zzac(this.zzala), this.zzavh, this.zzaky, this.zzavi, com.google.android.gms.common.internal.zze.xM);
    }
    ...
    public zzu zzim() {
        zzu zza = zzl.zzb(this.zzavj).zza(this.zzala, this.zzavh, this.zzaky, this.zzavi, 1);
        if (zza != null) {
            return zza;
        }
        zzl.zza(this.zzavj, this.zzala, "banner");
        return new zzak();
    }
