...
class zzi extends zzal {
    private static final String ID = zzaf.APP_VERSION_NAME.toString();
    ...
    public zza zzav(Map<String, zza> map) {
        try {
            return zzdl.zzap(this.mContext.getPackageManager().getPackageInfo(this.mContext.getPackageName(), 0).versionName);
