...
public interface zzec extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzec {
        ...
        private static class zza implements zzec {
            ...
            public void zza(zzdx com_google_android_gms_internal_zzdx) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.formats.client.IOnContentAdLoadedListener");
                    obtain.writeStrongBinder(com_google_android_gms_internal_zzdx != null ? com_google_android_gms_internal_zzdx.asBinder() : null);
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza(com.google.android.gms.internal.zzdx.zza.zzac(parcel.readStrongBinder()));
    ...
    void zza(zzdx com_google_android_gms_internal_zzdx) throws RemoteException;
}
