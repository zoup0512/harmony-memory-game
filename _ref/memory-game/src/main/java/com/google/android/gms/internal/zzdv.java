...
public interface zzdv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzdv {
        ...
        private static class zza implements zzdv {
            ...
            public zzd zzkv() throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.formats.client.INativeAppInstallAd");
        ...
        public static zzdv zzab(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
    ...
    zzd zzkv() throws RemoteException;
}
