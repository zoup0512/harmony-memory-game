...
public interface zzho extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzho {
        ...
        private static class zza implements zzho {
        ...
        public static zzho zzau(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.purchase.client.IInAppPurchaseListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzho)) ? new zza(iBinder) : (zzho) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza(com.google.android.gms.internal.zzhn.zza.zzat(parcel.readStrongBinder()));
