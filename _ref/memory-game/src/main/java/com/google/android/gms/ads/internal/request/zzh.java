...
public class zzh implements Creator<AdResponseParcel> {
    static void zza(AdResponseParcel adResponseParcel, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 28, adResponseParcel.zzcck, i, false);
        ...
        zzb.zza(parcel, 33, adResponseParcel.zzccn, i, false);
        ...
        zzb.zza(parcel, 37, adResponseParcel.zzccr, i, false);
    ...
    public AdResponseParcel[] zzap(int i) {
        return new AdResponseParcel[i];
    }

    public AdResponseParcel zzl(Parcel parcel) {
        ...
        while (parcel.dataPosition() < zzcm) {
            ...
            switch (zza.zzgm(zzcl)) {
                ...
                case 32:
                    ...
                    break;
                case 33:
                    rewardItemParcel = (RewardItemParcel) zza.zza(parcel, zzcl, (Creator) RewardItemParcel.CREATOR);
                    break;
                case 34:
                    list4 = zza.zzae(parcel, zzcl);
                    break;
                case 35:
                    list5 = zza.zzae(parcel, zzcl);
                    break;
                case 36:
                    z10 = zza.zzc(parcel, zzcl);
                    break;
                case 37:
                    autoClickProtectionConfigurationParcel = (AutoClickProtectionConfigurationParcel) zza.zza(parcel, zzcl, (Creator) AutoClickProtectionConfigurationParcel.CREATOR);
                    break;
                case 38:
