...
public final class RewardItemParcel extends AbstractSafeParcelable {
    ...
    @Nullable
    public static RewardItemParcel zzch(@Nullable String str) {
    ...
    public int hashCode() {
        return zzaa.hashCode(new Object[]{this.type, Integer.valueOf(this.zzcid)});
    }
    ...
    public JSONArray zzrw() throws JSONException {
