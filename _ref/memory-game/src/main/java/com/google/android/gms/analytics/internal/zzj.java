...
class zzj extends zzd implements Closeable {
    private static final String zzcxv = String.format("CREATE TABLE IF NOT EXISTS %s ( '%s' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, '%s' INTEGER NOT NULL, '%s' TEXT NOT NULL, '%s' TEXT NOT NULL, '%s' INTEGER);", new Object[]{"hits2", "hit_id", "hit_time", "hit_url", "hit_string", "hit_app_id"});
    private static final String zzcxw = String.format("SELECT MAX(%s) FROM %s WHERE 1;", new Object[]{"hit_time", "hits2"});
    private final zza zzcxx;
    private final zzal zzcxy = new zzal(zzyw());
    private final zzal zzcxz = new zzal(zzyw());

    class zza extends SQLiteOpenHelper {
        final /* synthetic */ zzj zzcya;

        zza(zzj com_google_android_gms_analytics_internal_zzj, Context context, String str) {
            this.zzcya = com_google_android_gms_analytics_internal_zzj;
        ...
        private boolean zza(SQLiteDatabase sQLiteDatabase, String str) {
            ...
            try {
                ...
                try {
                    ...
                    e = e2;
                    try {
                        this.zzcya.zzc("Error querying for table", str, e);
                        if (query != null) {
                            query.close();
                        }
                        return false;
        ...
        public SQLiteDatabase getWritableDatabase() {
            if (this.zzcya.zzcxz.zzx(3600000)) {
                SQLiteDatabase writableDatabase;
                try {
                    writableDatabase = super.getWritableDatabase();
                } catch (SQLiteException e) {
                    this.zzcya.zzcxz.start();
                    this.zzcya.zzel("Opening the database failed, dropping the table and recreating it");
                    this.zzcya.getContext().getDatabasePath(this.zzcya.zzaab()).delete();
                    try {
                        writableDatabase = super.getWritableDatabase();
                        this.zzcya.zzcxz.clear();
                    } catch (SQLiteException e2) {
                        this.zzcya.zze("Failed to open freshly created database", e2);
                        throw e2;
                    }
                }
        ...
        public void onOpen(SQLiteDatabase sQLiteDatabase) {
            ...
            if (zza(sQLiteDatabase, "hits2")) {
                ...
                sQLiteDatabase.execSQL(zzj.zzcxv);
            }
    ...
    zzj(zzf com_google_android_gms_analytics_internal_zzf) {
        ...
        this.zzcxx = new zza(this, com_google_android_gms_analytics_internal_zzf.getContext(), zzaab());
    }
    ...
    private String zzaab() {
        return !zzyy().zzabc() ? zzyy().zzacc() : zzyy().zzabd() ? zzyy().zzacc() : zzyy().zzacd();
    }

    private static String zzap(Map<String, String> map) {
        zzab.zzy(map);
    ...
    private String zzd(zzab com_google_android_gms_analytics_internal_zzab) {
        return com_google_android_gms_analytics_internal_zzab.zzadb() ? zzyy().zzabq() : zzyy().zzabr();
    }
    ...
    SQLiteDatabase getWritableDatabase() {
        try {
            return this.zzcxx.getWritableDatabase();
        } catch (SQLiteException e) {
    ...
    public void zzb(zzh com_google_android_gms_analytics_internal_zzh) {
        ...
        String zzap = zzap(com_google_android_gms_analytics_internal_zzh.zzm());
        ...
        contentValues.put(NativeProtocol.WEB_DIALOG_PARAMS, zzap);
        try {
    ...
    public void zzc(zzab com_google_android_gms_analytics_internal_zzab) {
        ...
        if (zze.length() > 8192) {
            zzyx().zza(com_google_android_gms_analytics_internal_zzab, "Hit length exceeds the maximum allowed size");
            return;
        }
        zzaaa();
        SQLiteDatabase writableDatabase = getWritableDatabase();
    ...
    Map<String, String> zzem(String str) {
    ...
    Map<String, String> zzen(String str) {
        if (TextUtils.isEmpty(str)) {
            return new HashMap(0);
        }
        try {
    ...
    L_0x0059:
        ...
        r2 = r13.zzem(r0);	 Catch:{ SQLiteException -> 0x00a4, all -> 0x00a2 }
    ...
    public java.util.List<com.google.android.gms.analytics.internal.zzh> zzt(long r14) {
        ...
        r3 = "params";
        r2[r1] = r3;	 Catch:{ SQLiteException -> 0x00ba, all -> 0x00b8 }
        r1 = r13.zzyy();	 Catch:{ SQLiteException -> 0x00ba, all -> 0x00b8 }
    ...
    L_0x0065:
        ...
        r8 = r13.zzen(r0);	 Catch:{ SQLiteException -> 0x00a8, all -> 0x00b8 }
    ...
    public int zzzy() {
        zzwu();
        zzzg();
        if (!this.zzcxy.zzx(86400000)) {
            return 0;
        }
        this.zzcxy.start();
        zzeh("Deleting stale hits (if any)");
        int delete = getWritableDatabase().delete("hits2", "hit_time < ?", new String[]{Long.toString(zzyw().currentTimeMillis() - 2592000000L)});
