...
public interface zzgm extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzgm {

        private static class zza implements zzgm {
        ...
        public static zzgm zzam(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzgm)) ? new zza(iBinder) : (zzgm) queryLocalInterface;
        }
