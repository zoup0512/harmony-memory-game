...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    public int hashCode() {
        return zzaa.hashCode(new Object[]{Integer.valueOf(this.ok), this.mPendingIntent, this.rc});
    }
    ...
    public String toString() {
        return zzaa.zzx(this).zzg("statusCode", getStatusString(this.ok)).zzg("resolution", this.mPendingIntent).zzg("message", this.rc).toString();
    }
