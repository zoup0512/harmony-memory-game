...
public interface zzb extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzb {
        ...
        private static class zza implements zzb {
            ...
            public void zznc(String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.plus.internal.IPlusCallbacks");
            ...
            public void zznd(String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.plus.internal.IPlusCallbacks");
        ...
        public static zzb zzkj(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 10:
                    parcel.enforceInterface("com.google.android.gms.plus.internal.IPlusCallbacks");
                    zzdu(parcel.readInt() != 0 ? (Status) Status.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
    ...
    void zzdu(Status status) throws RemoteException;

    void zzk(int i, Bundle bundle) throws RemoteException;

    void zznc(String str) throws RemoteException;

    void zznd(String str) throws RemoteException;
}
