    ...
    private static String zzd(String str, Object... objArr) {
        ...
        for (int i = 2; i < stackTrace.length; i++) {
            if (!stackTrace[i].getClass().equals(zzs.class)) {
                ...
                valueOf = new StringBuilder((String.valueOf(str2).length() + 1) + String.valueOf(valueOf).length()).append(str2).append(FileUtils.HIDDEN_PREFIX).append(valueOf).toString();
                break;
            }
        }
        valueOf = str2;
