...
public interface zzeb extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzeb {
        ...
        private static class zza implements zzeb {
            ...
            public void zza(zzdv com_google_android_gms_internal_zzdv) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.formats.client.IOnAppInstallAdLoadedListener");
                    obtain.writeStrongBinder(com_google_android_gms_internal_zzdv != null ? com_google_android_gms_internal_zzdv.asBinder() : null);
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza(com.google.android.gms.internal.zzdv.zza.zzab(parcel.readStrongBinder()));
    ...
    void zza(zzdv com_google_android_gms_internal_zzdv) throws RemoteException;
}
