...
public class zzh {
    ...
    private static final String zzbxk = String.format(Locale.US, "CREATE TABLE IF NOT EXISTS %s ( %s INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, %s TEXT NOT NULL, %s TEXT NOT NULL, %s INTEGER)", new Object[]{"InAppPurchase", "purchase_id", Param.PRODUCT_ID, "developer_payload", "record_time"});
    private static zzh zzbxm;
    private final zza zzbxl;

    zzh(Context context) {
        this.zzbxl = new zza(this, context, "google_inapp_purchase.db");
    }
    ...
    public static zzh zzs(Context context) {
        ...
        synchronized (zzail) {
            ...
            com_google_android_gms_ads_internal_purchase_zzh = zzbxm;
        }
    ...
    public SQLiteDatabase getWritableDatabase() {
        try {
            ...
            zzb.zzcx("Error opening writable conversion tracking database");
            return null;
        }
    }
    ...
    public void zza(zzf com_google_android_gms_ads_internal_purchase_zzf) {
        if (com_google_android_gms_ads_internal_purchase_zzf != null) {
            synchronized (zzail) {
                ...
                writableDatabase.delete("InAppPurchase", String.format(Locale.US, "%s = %d", new Object[]{"purchase_id", Long.valueOf(com_google_android_gms_ads_internal_purchase_zzf.zzbxf)}), null);
            }
        }
    }
    ...
    L_0x0011:
        ...
        r3 = "product_id";
        r4 = r7.zzbxh;	 Catch:{ all -> 0x000e }
        r2.put(r3, r4);	 Catch:{ all -> 0x000e }
        r3 = "developer_payload";
        r4 = r7.zzbxg;	 Catch:{ all -> 0x000e }
        r2.put(r3, r4);	 Catch:{ all -> 0x000e }
        r3 = "record_time";
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        zzb.zzcx(valueOf.length() == 0 ? new String(str) : str.concat(valueOf));
                        if (query != null) {
                            query.close();
                        }
                        return linkedList;
