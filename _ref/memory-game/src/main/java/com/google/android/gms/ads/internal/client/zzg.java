...
public class zzg implements Creator<AdRequestParcel> {
    static void zza(AdRequestParcel adRequestParcel, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 10, adRequestParcel.zzatt, i, false);
        zzb.zza(parcel, 11, adRequestParcel.zzatu, i, false);
    ...
    public AdRequestParcel zzc(Parcel parcel) {
    ...
    public AdRequestParcel[] zzr(int i) {
