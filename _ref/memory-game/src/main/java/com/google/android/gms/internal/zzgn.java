...
public interface zzgn extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzgn {
        ...
        private static class zza implements zzgn {
            ...
            public zzdr zzku() throws RemoteException {
                ...
                try {
                    ...
                    obtain2.readException();
                    zzdr zzy = com.google.android.gms.internal.zzdr.zza.zzy(obtain2.readStrongBinder());
                    return zzy;
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static zzgn zzan(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzgn)) ? new zza(iBinder) : (zzgn) queryLocalInterface;
        }
    ...
    zzdr zzku() throws RemoteException;
