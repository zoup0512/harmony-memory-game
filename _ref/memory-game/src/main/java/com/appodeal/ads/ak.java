...
import com.appodeal.ads.e.aa;
import com.appodeal.ads.e.ac;
import com.appodeal.ads.e.ae;
import com.appodeal.ads.e.ag;
import com.appodeal.ads.e.e;
import com.appodeal.ads.e.f;
import com.appodeal.ads.e.i;
import com.appodeal.ads.e.k;
import com.appodeal.ads.e.o;
import com.appodeal.ads.e.q;
import com.appodeal.ads.e.r;
import com.appodeal.ads.e.s;
import com.appodeal.ads.e.u;
import com.appodeal.ads.e.w;
import com.appodeal.ads.e.y;
...
public class ak {
    ...
    static RewardedVideoCallbacks d;
    static NonSkippableVideoCallbacks e;
    static int f = 0;
    ...
    private static class a implements com.appodeal.ads.t.a {
        ...
        public void a(JSONObject jSONObject, int i, String str) {
            try {
                if (ak.c || jSONObject.optBoolean("video_disabled")) {
                    ak.c = true;
                    Appodeal.a("Rewarded Video disabled");
                    ...
                    if (optJSONArray != null) {
                        for (int i2 = 0; i2 < optJSONArray.length(); i2++) {
                            ak.h.add(optJSONArray.getJSONObject(i2));
                        }
                    }
                    if (jSONObject.has("main_id")) {
                        ak.A = jSONObject.getString("main_id");
                    }
                    if (jSONObject.has("rri")) {
                        ak.s = jSONObject.optBoolean("rri");
                    }
                    if (jSONObject.has("ad_watch")) {
                        ak.t = jSONObject.optBoolean("ad_watch", true);
                    }
                    if (jSONObject.has("max_duration")) {
                        ak.w = jSONObject.optInt("max_duration", 0);
                    }
                    if (jSONObject.has("disable_long_video")) {
                        ak.x = jSONObject.optBoolean("disable_long_video", true);
                    }
                    if (ak.B == null && jSONObject.has("waterfall_cache_timeout")) {
                        ak.B = Integer.valueOf(jSONObject.getInt("waterfall_cache_timeout"));
                    }
                    if (ao.a == null && jSONObject.has("video_wo_banners")) {
                        ao.a = Boolean.valueOf(jSONObject.getBoolean("video_wo_banners"));
                    }
                    if (ak.r == null && jSONObject.has("ru")) {
                        ak.r = jSONObject.getString("ru");
                    }
                    if (jSONObject.has("fraud_detector")) {
                        ak.y = new m(jSONObject.getJSONObject("fraud_detector"));
                        ak.y.a(128);
                        ak.y.b(ak.A);
                    }
                    AppodealSettings.a(jSONObject);
                    b.a(ak.h, ak.i, 128);
                    ((ar) ak.m.get(i)).c = new ArrayList(ak.i);
                    an.a("Rewarded video", null, ak.i);
                    ((ar) ak.m.get(i)).m = ak.A;
                    ((ar) ak.m.get(i)).a = Long.valueOf(g.a().c());
                    if (!AppodealSettings.i) {
                        try {
                            ((ar) ak.m.get(i)).A = new com.appodeal.ads.d.g(jSONObject.optJSONObject("rtb"));
                            ((ar) ak.m.get(i)).A.a(jSONObject.optBoolean("disable_rtb"));
                            ((ar) ak.m.get(i)).A.b(jSONObject.optBoolean("for_kids"));
                            ((ar) ak.m.get(i)).A.a(jSONObject.optJSONObject("user_data"));
                            ((ar) ak.m.get(i)).A.b(jSONObject.optJSONObject("app_data"));
                            ((ar) ak.m.get(i)).y = jSONObject.optBoolean("disable_rtb");
                            if (!((ar) ak.m.get(i)).y) {
                                ((ar) ak.m.get(i)).z = ((ar) ak.m.get(i)).A.c().size() > 0;
                            }
                            if (AppodealSettings.g) {
                                ak.a(i, Double.valueOf(1.0E-4d));
                                return;
                            }
                        } catch (Throwable e) {
                            Appodeal.a(e);
                    ...
                    } else if (((ar) ak.m.get(i)).c.isEmpty()) {
                        am.a(true);
                    } else {
                        if (Appodeal.e != null) {
                            Appodeal.e.a(128);
    ...
    static class b implements com.appodeal.ads.d.i.a {
        ...
        public void a(int i, com.appodeal.ads.d.a aVar, h hVar) {
            ((ar) ak.m.get(i)).y = true;
            ((ar) ak.m.get(i)).x = -2;
            if (aVar == null) {
                am.a(i, ((ar) ak.m.get(i)).f(), ((ar) ak.m.get(i)).p, true);
            } else if (aVar.b() != null) {
                try {
                    if (!(Appodeal.e == null || ((ar) ak.m.get(i)).p == null)) {
                        Appodeal.e.a(128, ((ar) ak.m.get(i)).p.a(), false);
                    }
                    int size = ((ar) ak.m.get(i)).c.size();
                    ...
                    ((ar) ak.m.get(i)).c.add(jSONObject);
                    ak.a(size, false, i);
                } catch (Throwable e) {
                    Appodeal.a(e);
                }
    ...
    public static Set<ap> a(Context context) {
        if (a == null) {
            a = new HashSet();
            a(context, "adcolony", com.appodeal.ads.e.a.class, true, "com.jirbo.adcolony.AdColony");
            a(context, AppLovinSdk.URI_SCHEME, com.appodeal.ads.e.c.class, false, "com.applovin.sdk.AppLovinSdk");
            a(context, "chartboost", e.class, false, "com.chartboost.sdk.Chartboost");
            a(context, "flurry", com.appodeal.ads.e.g.class, true, "com.flurry.android.ads.FlurryAdInterstitial", "com.flurry.android.FlurryAgent");
            a(context, "mailru", com.appodeal.ads.e.m.class, false, "com.my.target.ads.InterstitialAd");
            ...
            a(context, "startapp", w.class, true, "com.startapp.android.publish.StartAppAd");
            a(context, "tapjoy", y.class, true, "com.tapjoy.Tapjoy");
            a(context, "unity_ads", aa.class, false, "com.unity3d.ads.UnityAds");
            a(context, FullAdType.VAST, ac.class, false, "org.nexage.sourcekit.vast.VASTPlayer");
            a(context, "rtbvast", r.class, false, "org.nexage.sourcekit.vast.VASTPlayer");
            a(context, "vpaid", ae.class, false, "com.appodeal.ads.networks.vpaid.VPAIDView");
            a(context, "vungle", ag.class, true, "com.vungle.publisher.VunglePub");
        }
        return a;
    }
    ...
    static void a(Activity activity) {
        if (!z && !b) {
            ...
            try {
                ...
                com.appodeal.ads.utils.c.d(activity);
                if (k) {
                    b(activity);
                }
                Appodeal.a("Rewarded Video Initialized");
                b = true;
            } catch (Throwable e) {
                Appodeal.a(e);
            }
    ...
    static void a(Activity activity, String str, boolean z) {
        try {
            if (!an.a((Context) activity)) {
                am.a();
            } else if (!Appodeal.a && !c && !g.a().b().d()) {
                if (a() == null) {
                    Appodeal.a(String.format("Caching Rewarded Video (debugType: %s, isLoaded: %s, isLoading: %s)", new Object[]{str, Boolean.valueOf(false), Boolean.valueOf(false)}));
                } else {
                    Appodeal.a(String.format("Caching Rewarded Video (debugType: %s, isLoaded: %s, isLoading: %s)", new Object[]{str, Boolean.valueOf(a().r), Boolean.valueOf(a().q)}));
                }
                ar arVar = new ar(str);
                m.add(arVar);
                if (m.size() > 0) {
                ...
                if (f() || arVar.a() || g == 0 || System.currentTimeMillis() - g > ((long) AppodealSettings.a(B))) {
    ...
    static void a(int i, Double d) {
        ...
        com.appodeal.ads.d.i iVar = new com.appodeal.ads.d.i(Appodeal.b, 4, i, ((ar) m.get(i)).A, new b(), valueOf, str, arVar.m);
    }
    ...
    public static void a(int i, boolean z, final int i2) {
        try {
            ...
            if (((ar) m.get(i2)).s && (((ar) m.get(i2)).l.optBoolean("offer") || (a3 != null && (a3.g() instanceof ac)))) {
                am.b(i2, f, a3);
            } else if (a3 == null) {
                am.a(i2, f);
                ...
                Appodeal.b.runOnUiThread(new Runnable() {
                    public void run() {
                        try {
                            if (!(Appodeal.e == null || ((ar) ak.m.get(i2)).s)) {
                                Appodeal.e.a(128, a3.a(), string2);
                            }
    ...
    static boolean a(final Activity activity, final c cVar, String str) {
        try {
            ...
            if (Appodeal.a || c || g.a().b().d()) {
                return false;
            }
            boolean equals = str.equals("debug_rewarded_video");
            if (m.isEmpty()) {
                Appodeal.a(String.format("Showing Rewarded Video (debugType: %s, isLoaded: %s, isLoading: %s, placement: '%s')", new Object[]{str, Boolean.valueOf(false), Boolean.valueOf(false), cVar.x()}));
                if (!cVar.a(128, null)) {
                    return false;
                }
                if (!equals && k) {
            ...
            Appodeal.a(String.format("Showing Rewarded Video (debugType: %s, isLoaded: %s, isLoading: %s, placement: '%s')", new Object[]{str, Boolean.valueOf(eVar.r), Boolean.valueOf(eVar.q), cVar.x()}));
            if (!cVar.a(128, eVar)) {
                return false;
            }
            if (eVar.r) {
        ...
        if (!v.contains(str)) {
            if (z) {
                com.appodeal.ads.utils.i.a(context, String.format("%s.dex", new Object[]{str}), strArr[0], new Runnable() {
                    public void run() {
                        if (!ak.v.contains(str)) {
                            try {
                                ap a = ak.b(cls, str, strArr);
                                if (a != null) {
                                    ak.a.add(a);
                                }
                            } catch (Throwable e) {
