...
public class RadialCountdownDrawable extends BaseWidgetDrawable {
    ...
    public RadialCountdownDrawable(@NonNull Context context) {
        ...
        float dipsToFloatPixels = Dips.dipsToFloatPixels(RadialCountdown.TEXT_SIZE_SP, context);
    ...
    public void updateCountdownProgress(int i) {
        ...
        this.mSweepAngle = (360.0f * ((float) i)) / ((float) this.mInitialCountdownMilliseconds);
        invalidateSelf();
    }
