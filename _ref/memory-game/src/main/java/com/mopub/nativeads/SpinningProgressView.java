...
class SpinningProgressView extends ViewGroup {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        if (z) {
            int i5 = (i + i3) / 2;
            int i6 = (i2 + i4) / 2;
            this.mProgressBar.layout(i5 - this.mProgressIndicatorRadius, i6 - this.mProgressIndicatorRadius, i5 + this.mProgressIndicatorRadius, i6 + this.mProgressIndicatorRadius);
        }
    }
