...
public final class MoPubRecyclerAdapter extends Adapter<ViewHolder> {
    ...
    MoPubRecyclerAdapter(@NonNull MoPubStreamAdPlacer moPubStreamAdPlacer, @NonNull Adapter adapter, @NonNull VisibilityTracker visibilityTracker) {
        ...
        this.mAdapterDataObserver = new AdapterDataObserver() {
            ...
            public void onItemRangeInserted(int i, int i2) {
                ...
                if (ContentChangeStrategy.KEEP_ADS_FIXED == MoPubRecyclerAdapter.this.mStrategy || (ContentChangeStrategy.INSERT_AT_END == MoPubRecyclerAdapter.this.mStrategy && itemCount != 0)) {
                    MoPubRecyclerAdapter.this.notifyDataSetChanged();
                    return;
                }
                while (i3 < i2) {
            ...
            public void onItemRangeRemoved(int i, int i2) {
                ...
                if (ContentChangeStrategy.KEEP_ADS_FIXED == MoPubRecyclerAdapter.this.mStrategy || (ContentChangeStrategy.INSERT_AT_END == MoPubRecyclerAdapter.this.mStrategy && i4 != 0)) {
                    MoPubRecyclerAdapter.this.notifyDataSetChanged();
                    return;
                }
                i4 = MoPubRecyclerAdapter.this.mStreamAdPlacer.getAdjustedCount(itemCount + i2);
                while (i3 < i2) {
                    MoPubRecyclerAdapter.this.mStreamAdPlacer.removeItem(i);
                    i3++;
                }
                i4 -= MoPubRecyclerAdapter.this.mStreamAdPlacer.getAdjustedCount(itemCount);
    ...
    private void handleVisibilityChanged(List<View> list, List<View> list2) {
