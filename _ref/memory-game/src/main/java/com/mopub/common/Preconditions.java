...
public final class Preconditions {
    ...
    public static void checkArgument(boolean z) {
        checkArgumentInternal(z, false, "Illegal argument.", "");
    }
    ...
    public static void checkState(boolean z) {
        checkStateInternal(z, false, "Illegal state.", "");
    }
    ...
    private static boolean checkArgumentInternal(boolean z, boolean z2, String str, Object... objArr) {
        if (z) {
            return true;
        }
    ...
    private static boolean checkUiThreadInternal(boolean z, String str, Object... objArr) {
