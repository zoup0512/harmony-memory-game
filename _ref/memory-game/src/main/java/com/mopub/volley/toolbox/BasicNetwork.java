...
public class BasicNetwork implements Network {
    ...
    private static int SLOW_REQUEST_THRESHOLD_MS = res.facebook;
    ...
    L_0x0004:
        ...
        r0 = r18;
        r0.addCacheHeaders(r2, r4);	 Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b1, MalformedURLException -> 0x00c0, IOException -> 0x00de }
        r0 = r18;
        r4 = r0.mHttpStack;	 Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b1, MalformedURLException -> 0x00c0, IOException -> 0x00de }
        r0 = r19;
        ...
        r6 = convertHeaders(r2);	 Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b1, MalformedURLException -> 0x00c0, IOException -> 0x0137 }
    ...
    L_0x006b:
        r2 = r15.getEntity();	 Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b1, MalformedURLException -> 0x00c0, IOException -> 0x0137 }
        r0 = r18;
        r11 = r0.entityToBytes(r2);	 Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b1, MalformedURLException -> 0x00c0, IOException -> 0x0137 }
    L_0x0075:
        ...
        r7 = r18;
        r10 = r19;
        r7.logSlowRequests(r8, r10, r11, r12);	 Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b1, MalformedURLException -> 0x00c0, IOException -> 0x013b }
    ...
    private void addCacheHeaders(Map<String, String> map, Entry entry) {
        if (entry != null) {
            ...
            if (entry.serverDate > 0) {
                map.put(Headers.GET_OBJECT_IF_MODIFIED_SINCE, DateUtils.formatDate(new Date(entry.serverDate)));
            }
        }
    }
