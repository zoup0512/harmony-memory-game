...
class TransferDBBase {
    ...
    public TransferDBBase(Context context) {
        ...
        this.contentUri = Uri.parse("content://" + mAuthority + "/" + BASE_PATH);
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriType) {
            case 10:
                return Uri.parse("transfers/" + db.insert(TransferTable.TABLE_TRANSFER, null, values));
            default:
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        return queryBuilder.query(this.databaseHelper.getWritableDatabase(), projection, selection, selectionArgs, null, null, sortOrder);
    }
    ...
    public synchronized int update(Uri uri, ContentValues values, String whereClause, String[] whereArgs) {
        ...
        switch (uriType) {
            ...
            case 20:
                ...
                rowsUpdated = db.update(TransferTable.TABLE_TRANSFER, values, "_id=" + id, null);
                break;
            default:
                throw new IllegalArgumentException("Unknown URI: " + uri);
        }
        ...
        switch (uriType) {
            ...
            case 20:
                ...
                if (TextUtils.isEmpty(selection)) {
                    return db.delete(TransferTable.TABLE_TRANSFER, "_id=" + id, null);
                }
    ...
    public int bulkInsert(Uri uri, ContentValues[] valuesArray) {
        ...
        switch (uriType) {
            case 10:
                try {
                    db.beginTransaction();
                    mainUploadId = (int) db.insertOrThrow(TransferTable.TABLE_TRANSFER, null, valuesArray[0]);
