...
public abstract class AbstractAWSSigner implements Signer {
    ...
    protected String getCanonicalizedQueryString(Map<String, String> parameters) {
        ...
        for (Entry<String, String> pair : parameters.entrySet()) {
            Entry<String, String> pair2;
            sorted.put(HttpUtils.urlEncode((String) pair2.getKey(), false), HttpUtils.urlEncode((String) pair2.getValue(), false));
        }
        StringBuilder builder = new StringBuilder();
        Iterator<Entry<String, String>> pairs = sorted.entrySet().iterator();
        while (pairs.hasNext()) {
            pair2 = (Entry) pairs.next();
