...
public class STSAssumeRoleSessionCredentialsProvider implements AWSCredentialsProvider {
    ...
    private void startSession() {
        Credentials stsCredentials = this.securityTokenService.assumeRole(new AssumeRoleRequest().withRoleArn(this.roleArn).withDurationSeconds(Integer.valueOf(900)).withRoleSessionName(this.roleSessionName)).getCredentials();
