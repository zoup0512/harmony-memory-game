...
public class XmlResponsesSaxParser {
        ...
        protected void doEndElement(String uri, String name, String qName) {
            if (!in("CORSConfiguration")) {
                ...
                if (name.equals("ID")) {
                    ...
                    this.allowedMethods.add(AllowedMethods.fromValue(getText()));
        ...
        protected void doStartElement(String uri, String name, String qName, Attributes attrs) {
            if (!in("LifecycleConfiguration")) {
                ...
                if (name.equals("Transition")) {
                    ...
                    this.currentNcvTransition = new NoncurrentVersionTransition();
                }
            ...
            if (!in("NotificationConfiguration", "TopicConfiguration")) {
                if (in("NotificationConfiguration") && name.equals("TopicConfiguration")) {
                    if (!(this.topic == null || this.event == null)) {
                        this.configuration.getTopicConfigurations().add(new TopicConfiguration(this.topic, this.event));
                    }
                    this.topic = null;
                    this.event = null;
                }
    ...
    public static class DeleteObjectsHandler extends AbstractHandler {
        ...
        protected void doStartElement(String uri, String name, String qName, Attributes attrs) {
            ...
            if (name.equals("Deleted")) {
                this.currentDeletedObject = new DeletedObject();
            } else if (name.equals("Error")) {
                this.currentError = new DeleteError();
            }
        }
        ...
        protected void doEndElement(String uri, String name, String qName) {
            if (!in("DeleteResult")) {
                if (!in("DeleteResult", "Deleted")) {
                    ...
                    this.currentDeletedObject.setDeleteMarker(getText().equals(ServerProtocol.DIALOG_RETURN_SCOPES_TRUE));
        ...
        protected void doEndElement(String uri, String name, String qName) {
            if (!atTopLevel()) {
                if (!in("ListBucketResult")) {
                    ...
                    } else if (isTruncatedStr.startsWith(ServerProtocol.DIALOG_RETURN_SCOPES_TRUE)) {
                ...
                if (!this.objectListing.getObjectSummaries().isEmpty()) {
                    nextMarker = ((S3ObjectSummary) this.objectListing.getObjectSummaries().get(this.objectListing.getObjectSummaries().size() - 1)).getKey();
                    ...
                    nextMarker = (String) this.objectListing.getCommonPrefixes().get(this.objectListing.getCommonPrefixes().size() - 1);
                }
        ...
        protected void doEndElement(String uri, String name, String qName) {
            if (!atTopLevel()) {
                ...
                if (this.result.getObjectSummaries().isEmpty()) {
                    ...
                    nextContinuationToken = ((S3ObjectSummary) this.result.getObjectSummaries().get(this.result.getObjectSummaries().size() - 1)).getKey();
                }
            ...
            if (!in("ListVersionsResult")) {
                if (!in("ListVersionsResult", "CommonPrefixes")) {
                    ...
                    if (name.equals("Key")) {
                        ...
                        this.currentVersionSummary.setIsLatest(ServerProtocol.DIALOG_RETURN_SCOPES_TRUE.equals(getText()));
                    } else if (name.equals("LastModified")) {
                ...
                this.versionListing.setTruncated(ServerProtocol.DIALOG_RETURN_SCOPES_TRUE.equals(getText()));
    ...
    public static class RequestPaymentConfigurationHandler extends AbstractHandler {
        ...
        public RequestPaymentConfiguration getConfiguration() {
            return new RequestPaymentConfiguration(Payer.valueOf(this.payer));
        }
    ...
    protected void parseXmlInputStream(DefaultHandler handler, InputStream inputStream) throws IOException {
        try {
            ...
            AmazonClientException amazonClientException = new AmazonClientException("Failed to parse XML document with handler " + handler.getClass(), t);
        }
    }
    ...
    protected InputStream sanitizeXmlDocument(DefaultHandler handler, InputStream inputStream) throws IOException {
        ...
        try {
            ...
            AmazonClientException amazonClientException = new AmazonClientException("Failed to sanitize XML document destined for handler " + handler.getClass(), t);
        }
    }
