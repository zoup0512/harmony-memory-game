    ...
    public ProvisionedThroughput unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ReadCapacityUnits")) {
                provisionedThroughput.setReadCapacityUnits(LongJsonUnmarshaller.getInstance().unmarshall(context));
            } else if (name.equals("WriteCapacityUnits")) {
                provisionedThroughput.setWriteCapacityUnits(LongJsonUnmarshaller.getInstance().unmarshall(context));
            } else {
                reader.skipValue();
            }
        }
