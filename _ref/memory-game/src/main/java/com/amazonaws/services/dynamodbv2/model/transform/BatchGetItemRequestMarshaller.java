    ...
    public Request<BatchGetItemRequest> marshall(BatchGetItemRequest batchGetItemRequest) {
        ...
        try {
            ...
            if (batchGetItemRequest.getRequestItems() != null) {
                ...
                jsonWriter.beginObject();
                for (Entry<String, KeysAndAttributes> requestItemsEntry : requestItems.entrySet()) {
                    KeysAndAttributes requestItemsValue = (KeysAndAttributes) requestItemsEntry.getValue();
                    if (requestItemsValue != null) {
                        jsonWriter.name((String) requestItemsEntry.getKey());
