    ...
    public Request<PutItemRequest> marshall(PutItemRequest putItemRequest) {
        ...
        try {
            ...
            if (putItemRequest.getItem() != null) {
                ...
                jsonWriter.beginObject();
                for (Entry<String, AttributeValue> itemEntry : item.entrySet()) {
                    AttributeValue itemValue = (AttributeValue) itemEntry.getValue();
                    if (itemValue != null) {
                        jsonWriter.name((String) itemEntry.getKey());
