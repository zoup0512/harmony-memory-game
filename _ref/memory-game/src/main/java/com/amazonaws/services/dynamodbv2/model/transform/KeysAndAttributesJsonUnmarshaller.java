    ...
    public KeysAndAttributes unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Keys")) {
                ...
                keysAndAttributes.setAttributesToGet(new ListUnmarshaller(StringJsonUnmarshaller.getInstance()).unmarshall(context));
                ...
                keysAndAttributes.setExpressionAttributeNames(new MapUnmarshaller(StringJsonUnmarshaller.getInstance()).unmarshall(context));
            } else {
                reader.skipValue();
            }
        }
