...
public class PredefinedRetryPolicies {
    ...
    public static final BackoffStrategy DEFAULT_BACKOFF_STRATEGY = new SDKDefaultBackoffStrategy(100, 20000);
    ...
    private static class SDKDefaultBackoffStrategy implements BackoffStrategy {
