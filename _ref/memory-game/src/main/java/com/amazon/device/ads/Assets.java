...
class Assets {
    ...
    private static final String LOGTAG = Assets.class.getSimpleName();
    ...
    public synchronized boolean ensureAssetsCreated() {
        ...
        r0 = 0;
        monitor-enter(r9);
        r2 = r9.baseFilePath;	 Catch:{ all -> 0x0069 }
        if (r2 != 0) goto L_0x0014;
    L_0x0008:
        r2 = r9.getBaseFilePath();	 Catch:{ all -> 0x0069 }
        r9.baseFilePath = r2;	 Catch:{ all -> 0x0069 }
        r2 = r9.baseFilePath;	 Catch:{ all -> 0x0069 }
        if (r2 != 0) goto L_0x0014;
    L_0x0012:
        monitor-exit(r9);
    ...
    L_0x0014:
        ...
        r4 = r9.settings;	 Catch:{ all -> 0x0069 }
        r5 = "mraid-assets-version";
        r6 = 0;
        r4 = r4.getInt(r5, r6);	 Catch:{ all -> 0x0069 }
        if (r4 >= r7) goto L_0x0044;
    L_0x0023:
        r4 = r9.logger;	 Catch:{ all -> 0x0069 }
        r5 = "Writing assets to disk: version %d";
        r6 = 1;
        r6 = new java.lang.Object[r6];	 Catch:{ all -> 0x0069 }
        r7 = 0;
        r8 = 5;
        r8 = java.lang.Integer.valueOf(r8);	 Catch:{ all -> 0x0069 }
        r6[r7] = r8;	 Catch:{ all -> 0x0069 }
        r4.d(r5, r6);	 Catch:{ all -> 0x0069 }
        r4 = r9.writeAssetsToDisk();	 Catch:{ all -> 0x0069 }
        if (r4 == 0) goto L_0x005d;
    L_0x003b:
        r0 = r9.settings;	 Catch:{ all -> 0x0069 }
        r4 = "mraid-assets-version";
        r5 = 5;
        r0.putInt(r4, r5);	 Catch:{ all -> 0x0069 }
        r0 = r1;
    L_0x0044:
        r4 = java.lang.System.nanoTime();	 Catch:{ all -> 0x0069 }
        r2 = r4 - r2;
        r2 = com.amazon.device.ads.NumberUtils.convertToMillisecondsFromNanoseconds(r2);	 Catch:{ all -> 0x0069 }
        r4 = r9.metrics;	 Catch:{ all -> 0x0069 }
        r4 = r4.getMetricsCollector();	 Catch:{ all -> 0x0069 }
        if (r0 == 0) goto L_0x006c;
    L_0x0056:
        r0 = com.amazon.device.ads.Metrics.MetricType.ASSETS_CREATED_LATENCY;	 Catch:{ all -> 0x0069 }
    L_0x0058:
        r4.publishMetricInMilliseconds(r0, r2);	 Catch:{ all -> 0x0069 }
        r0 = r1;
        goto L_0x0012;
    L_0x005d:
        r1 = r9.metrics;	 Catch:{ all -> 0x0069 }
        r1 = r1.getMetricsCollector();	 Catch:{ all -> 0x0069 }
        r2 = com.amazon.device.ads.Metrics.MetricType.ASSETS_FAILED;	 Catch:{ all -> 0x0069 }
        r1.incrementMetric(r2);	 Catch:{ all -> 0x0069 }
        goto L_0x0012;
    L_0x0069:
        r0 = move-exception;
        monitor-exit(r9);
        throw r0;
    L_0x006c:
        r0 = com.amazon.device.ads.Metrics.MetricType.ASSETS_ENSURED_LATENCY;	 Catch:{ all -> 0x0069 }
        goto L_0x0058;
        */
    ...
    private boolean writeAssetsToDisk() {
        ...
        writeBase64EncodedAssetToDisk(circuitBreaker, AssetsBase64.BASE64_CLOSE_NORMAL, getFilePath(CLOSE_NORMAL));
        writeBase64EncodedAssetToDisk(circuitBreaker, AssetsBase64.BASE64_CLOSE_PRESSED, getFilePath(CLOSE_PRESSED));
        writeBase64EncodedAssetToDisk(circuitBreaker, AssetsBase64.BASE64_CLOSE, getFilePath(CLOSE));
        writeBase64EncodedAssetToDisk(circuitBreaker, AssetsBase64.BASE64_LEFT_ARROW, getFilePath(LEFT_ARROW));
        writeBase64EncodedAssetToDisk(circuitBreaker, AssetsBase64.BASE64_REFRESH, getFilePath(REFRESH));
        writeBase64EncodedAssetToDisk(circuitBreaker, AssetsBase64.BASE64_RIGHT_ARROW, getFilePath(RIGHT_ARROW));
        writeBase64EncodedAssetToDisk(circuitBreaker, AssetsBase64.BASE64_INTERSTITIAL_CLOSE_NORMAL, getFilePath(CLOSE_NORMAL));
        writeBase64EncodedAssetToDisk(circuitBreaker, AssetsBase64.BASE64_INTERSTITIAL_CLOSE_PRESSED, getFilePath(CLOSE_PRESSED));
        writeBase64EncodedAssetToDisk(circuitBreaker, AssetsBase64.BASE64_OPEN_EXTERNAL_BROWSER, getFilePath(OPEN_EXTERNAL_BROWSER));
    ...
    private void writeAssetToDisk(CircuitBreaker circuitBreaker, byte[] bArr, String str) {
        if (!circuitBreaker.isBroken()) {
            ...
            if (createFileOutputHandler.open(WriteMethod.OVERWRITE)) {
                try {
                    createFileOutputHandler.write(bArr);
                } catch (IOException e) {
                    this.logger.w("Caught IOException while writing asset to disk: %s", str);
    ...
    protected void writeBytesToOutputStream(OutputStream outputStream, byte[] bArr) {
