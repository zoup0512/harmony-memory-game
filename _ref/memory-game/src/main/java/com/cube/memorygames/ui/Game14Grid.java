...
public class Game14Grid extends View implements GameGrid {
    ...
    public Game14Grid(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public Game14Grid(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setElements(List<ElementGame14> elements) {
