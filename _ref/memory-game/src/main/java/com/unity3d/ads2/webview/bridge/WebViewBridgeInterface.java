...
public class WebViewBridgeInterface {
    ...
    public void handleInvocation(String str) {
        ...
        for (int i2 = 0; i2 < jSONArray.length(); i2++) {
            ...
            if (str3 == null || !str3.contains(BuildConfig.APPLICATION_ID)) {
                str2 = str3;
            } else {
                str2 = str3.replace(BuildConfig.APPLICATION_ID, "com.unity3d.ads2");
            }
            invocation.addInvocation(str2, (String) jSONArray2.get(1), getParameters((JSONArray) jSONArray2.get(2)), new WebViewCallback((String) jSONArray2.get(3), invocation.getId()));
        }
