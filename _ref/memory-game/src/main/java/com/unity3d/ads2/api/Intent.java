...
public class Intent {
    ...
    public static void launch(JSONObject jSONObject, WebViewCallback webViewCallback) {
        ...
        String str2 = (String) jSONObject.opt("className");
        if (str2 == null || !str2.contains(BuildConfig.APPLICATION_ID)) {
            str = str2;
        } else {
            str = str2.replace(BuildConfig.APPLICATION_ID, "com.unity3d.ads2");
        }
        str2 = (String) jSONObject.opt("packageName");
