...
import com.unity3d.ads2.adunit.AdUnitOpen;
import com.unity3d.ads2.api.AdUnit;
import com.unity3d.ads2.api.Broadcast;
import com.unity3d.ads2.api.Cache;
import com.unity3d.ads2.api.Connectivity;
import com.unity3d.ads2.api.DeviceInfo;
import com.unity3d.ads2.api.Intent;
import com.unity3d.ads2.api.Listener;
import com.unity3d.ads2.api.Placement;
import com.unity3d.ads2.api.Request;
import com.unity3d.ads2.api.Resolve;
import com.unity3d.ads2.api.Sdk;
import com.unity3d.ads2.api.Storage;
import com.unity3d.ads2.api.VideoPlayer;
import com.unity3d.ads2.cache.CacheThread;
import com.unity3d.ads2.configuration.Configuration;
import com.unity3d.ads2.configuration.EnvironmentCheck;
import com.unity3d.ads2.configuration.InitializeThread;
...
public final class UnityAds {
    ...
    public static boolean isReady() {
        return isSupported() && isInitialized() && com.unity3d.ads2.placement.Placement.isReady();
    }

    public static boolean isReady(String str) {
        return isSupported() && isInitialized() && str != null && com.unity3d.ads2.placement.Placement.isReady(str);
    }

    public static PlacementState getPlacementState() {
        if (isSupported() && isInitialized()) {
            return com.unity3d.ads2.placement.Placement.getPlacementState();
        }
    ...
    public static PlacementState getPlacementState(String str) {
        if (isSupported() && isInitialized() && str != null) {
            return com.unity3d.ads2.placement.Placement.getPlacementState(str);
        }
        return PlacementState.NOT_AVAILABLE;
    }

    public static void show(Activity activity) {
        show(activity, com.unity3d.ads2.placement.Placement.getDefaultPlacement());
    }
                ...
                public void run() {
                    ...
                    try {
                        if (!AdUnitOpen.open(str, jSONObject)) {
                            ...
                            com.unity3d.ads2.placement.Placement.reset();
                            CacheThread.cancel();
                            ConnectivityMonitor.stopAll();
                        }
                    } catch (Exception e2) {
                        DeviceLog.exception("Could not get callback method", e2);
                        UnityAds.handleShowError(str, UnityAdsError.SHOW_ERROR, "Could not get com.unity3d.ads2.properties.showCallback method");
                    }
                }
            }).start();
        } else if (!isSupported()) {
