...
import com.unity3d.ads2.device.StorageError;
...
public class Storage {
    ...
    private static void set(String str, String str2, Object obj, WebViewCallback webViewCallback) {
        com.unity3d.ads2.device.Storage storage = getStorage(str);
        if (storage == null) {
    ...
    private static com.unity3d.ads2.device.Storage getStorage(String str) {
