...
public class YAxisRendererHorizontalBarChart extends YAxisRenderer {
    ...
    public void computeAxis(float yMin, float yMax, boolean inverted) {
        if (this.mViewPortHandler.contentHeight() > CropImageView.DEFAULT_MAX_SCALE_MULTIPLIER && !this.mViewPortHandler.isFullyZoomedOutX()) {
    ...
    protected void drawZeroLine(Canvas c) {
        ...
        zeroLinePath.reset();
        zeroLinePath.moveTo(((float) pos.x) - DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, this.mViewPortHandler.contentTop());
        zeroLinePath.lineTo(((float) pos.x) - DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, this.mViewPortHandler.contentBottom());
