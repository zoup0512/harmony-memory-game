...
public class ChartAnimator {
    ...
    protected float mPhaseX = DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
    protected float mPhaseY = DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
    ...
    public void animateXY(int durationMillisX, int durationMillisY, EasingFunction easingX, EasingFunction easingY) {
        if (VERSION.SDK_INT >= 11) {
            ObjectAnimator animatorY = ObjectAnimator.ofFloat(this, "phaseY", new float[]{0.0f, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT});
            animatorY.setInterpolator(easingY);
            animatorY.setDuration((long) durationMillisY);
            ObjectAnimator animatorX = ObjectAnimator.ofFloat(this, "phaseX", new float[]{0.0f, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT});
