...
public final class Vector3 {
    public static final Vector3 UNIT_X = new Vector3(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, 0.0f, 0.0f);
    public static final Vector3 UNIT_Y = new Vector3(0.0f, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, 0.0f);
    public static final Vector3 UNIT_Z = new Vector3(0.0f, 0.0f, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
