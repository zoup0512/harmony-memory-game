...
public class ColorTemplate {
    public static final int[] COLORFUL_COLORS = new int[]{Color.rgb(193, 37, 82), Color.rgb(255, 102, 0), Color.rgb(245, 199, 0), Color.rgb(106, CtaButton.WIDTH_DIPS, 31), Color.rgb(179, 100, 53)};
    ...
    public static final int[] LIBERTY_COLORS = new int[]{Color.rgb(207, 248, 246), Color.rgb(148, 212, 212), Color.rgb(136, 180, 187), Color.rgb(118, 174, 175), Color.rgb(42, 109, TransportMediator.KEYCODE_MEDIA_RECORD)};
    ...
    public static int getColorWithAlphaComponent(int color, int alpha) {
        return (ViewCompat.MEASURED_SIZE_MASK & color) | ((alpha & 255) << 24);
    }
