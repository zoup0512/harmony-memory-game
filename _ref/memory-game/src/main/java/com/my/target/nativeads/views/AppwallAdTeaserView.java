...
public class AppwallAdTeaserView extends RelativeLayout {
    ...
    private int textColor = Color.rgb(36, 36, 36);
    ...
    private void initView() {
        ...
        int px2 = getPx(14);
        int px3 = getPx(53);
        GradientDrawable gradientDrawable = new GradientDrawable(Orientation.TOP_BOTTOM, new int[]{-1, -1052689});
        gradientDrawable = new GradientDrawable(Orientation.TOP_BOTTOM, new int[]{-1903365, -3806472});
        setBackgroundColor(-1);
        LayoutParams layoutParams = new RelativeLayout.LayoutParams((px3 + px2) + px2, (px3 + px) + px);
        ...
        LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(px4, px4);
        ...
        px4 = getPx(6);
        this.coinsBgShape = new ShapeDrawable(new RoundRectShape(new float[]{(float) px4, (float) px4, (float) px4, (float) px4, (float) px4, (float) px4, (float) px4, (float) px4}, null, null));
        layoutParams = new RelativeLayout.LayoutParams(px3, px3);
        ...
        addView(this.coinsLayout, layoutParams);
        ...
        this.coinsLayout.addView(this.coinsCountView, layoutParams3);
        layoutParams3 = new LinearLayout.LayoutParams(getPx(20), getPx(20));
        this.coinsIconView = new CacheImageView(getContext());
        layoutParams3.gravity = 1;
        this.coinsLayout.addView(this.coinsIconView, layoutParams3);
        layoutParams3 = new RelativeLayout.LayoutParams(getPx(19), -2);
        layoutParams3.addRule(15);
        layoutParams3.addRule(11);
        layoutParams3.rightMargin = getPx(30);
        this.openImageView = new CacheImageView(getContext());
        addView(this.openImageView, layoutParams3);
        layoutParams3 = new RelativeLayout.LayoutParams(px3, px3);
        layoutParams3.addRule(10);
        layoutParams3.addRule(11);
        this.statusIconView = new CacheImageView(getContext());
        addView(this.statusIconView, layoutParams3);
        this.titleView = new TextView(getContext());
        this.titleView.setTypeface(Typeface.SANS_SERIF);
        this.titleView.setTextSize(2, RadialCountdown.TEXT_SIZE_SP);
        this.titleView.setTextColor(this.textColor);
        this.titleView.setPadding(0, 0, getPx(67), 0);
        this.titleView.setId(3);
        layoutParams3 = new RelativeLayout.LayoutParams(-1, -2);
        layoutParams3.leftMargin = getPx(91);
        layoutParams3.rightMargin = getPx(15);
        layoutParams3.topMargin = getPx(13);
        ...
        this.descrView.setLayoutParams(layoutParams3);
        addView(this.descrView);
        layoutParams3 = new RelativeLayout.LayoutParams(getPx(73), getPx(12));
        ...
        this.starsRatingView.setStarsPadding((float) getPx(2));
        this.starsRatingView.setId(2);
        addView(this.starsRatingView, layoutParams3);
        ...
        addView(this.votesCountView, layoutParams3);
    }
    ...
    public void setNativeAppwallBanner(NativeAppwallBanner nativeAppwallBanner) {
        ...
        CharSequence description = nativeAppwallBanner.getDescription();
