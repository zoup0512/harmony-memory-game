...
public class MyTargetActivity extends Activity implements a, CustomWebView.a {
    ...
    private void processIntent(Intent intent) {
        if ("com.my.target.actions.webview".equals(intent.getAction())) {
            Object stringExtra = intent.getStringExtra(WEB_VIEW_URL);
    ...
    private void setupActionBarForAppwall(NativeAppwallAd nativeAppwallAd) {
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            if (actionBar != null) {
                ...
                actionBar.setElevation((float) this.uiUtils.a(4));
            }
            ...
            setTheme(16973830);
            View adTitle = new AdTitle(this);
            adTitle.setLabel(nativeAppwallAd.getTitle());
            adTitle.setCloseClickListener(this);
            adTitle.setLayoutParams(new LayoutParams(-1, this.uiUtils.a(52)));
    ...
    private void setActionbarTextColor(ActionBar actionBar, int i) {
        if (VERSION.SDK_INT >= 11) {
            CharSequence spannableStringBuilder = new SpannableStringBuilder(actionBar.getTitle());
