...
public final class p {
    ...
    public enum a {
        ...
        static final SparseArray<a> D = null;
        private final int E;
    ...
    public static h a(aj ajVar) {
        return new e(ajVar == null ? "" : ajVar.a(), a.EVENT_TYPE_ACTIVATION.b(), a.EVENT_TYPE_ACTIVATION.a());
    }
    ...
    static h a(int i, String str, String str2, Map<String, Object> map) {
        return new e(str2, str, a.EVENT_TYPE_CUSTOM_EVENT.a(), i).e(bg.b((Map) map));
    }
}
