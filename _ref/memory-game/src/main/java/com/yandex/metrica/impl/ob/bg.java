...
public class bg implements bf {
    ...
    public boolean a(android.database.sqlite.SQLiteDatabase r15) {
        ...
        r12 = 0;
        r11 = 1;
        r1 = r14.a;	 Catch:{ Exception -> 0x0042 }
    ...
    L_0x002e:
        com.yandex.metrica.impl.bg.a(r2);	 Catch:{ Exception -> 0x0042 }
        r1 = r10;
    L_0x0032:
        return r1;
    L_0x0033:
        ...
        r1 = r14.a(r2, r1);	 Catch:{ all -> 0x004d }
        r11 = r11 & r1;
        com.yandex.metrica.impl.bg.a(r2);	 Catch:{ Exception -> 0x0042 }
        goto L_0x000d;
    L_0x0042:
    ...
    L_0x004d:
        ...
        goto L_0x0047;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.yandex.metrica.impl.ob.bg.a(android.database.sqlite.SQLiteDatabase):boolean");
    }
