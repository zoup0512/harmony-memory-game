    ...
    static final class PartMap<T> extends ParameterHandler<Map<String, T>> {
        ...
        void apply(RequestBuilder builder, Map<String, T> value) throws IOException {
            ...
            for (Entry<String, T> entry : value.entrySet()) {
                ...
                builder.addPart(Headers.of(com.amazonaws.services.s3.Headers.CONTENT_DISPOSITION, "form-data; name=\"" + entryKey + "\"", "Content-Transfer-Encoding", this.transferEncoding), (RequestBody) this.valueConverter.convert(entryValue));
            }
        }
    }
